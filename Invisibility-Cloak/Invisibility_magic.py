...
cv2.createTrackbar("upper_hue","bars",140,180,hello)
cv2.createTrackbar("upper_saturation","bars",255, 255, hello)
cv2.createTrackbar("upper_value","bars",255, 255, hello)
cv2.createTrackbar("lower_hue","bars",100,180, hello)
cv2.createTrackbar("lower_saturation","bars",150, 255, hello)
cv2.createTrackbar("lower_value","bars",50, 255, hello)
...
while(True):
	...
	cv2.imshow("Invisiblity Cloak",final)
